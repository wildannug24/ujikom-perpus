...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO ulasan (buku_id, user_id, ulasan, rating)
    VALUES (1, 1, '$review_content', $rating)"; // Anda harus mengganti nilai buku_id dan user_id sesuai dengan data yang sebenarnya
...
<body class="bg-gradient-to-r from-blue-300 to-blue-300 font-sans">
    ...
    <header class="bg-blue-500 text-white py-4 text-center">
        ...
        <h1 class="text-3xl font-bold">Ulasan Buku</h1>
    </header>
